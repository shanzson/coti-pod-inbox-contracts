...
contract PodErc20MintableFixed is PodERC20Fixed {
    ...
    ) PodERC20Fixed(_cotiChainId, _inbox, _cotiSideContract, _name, _symbol) {
        _initializeMintableMinter(_minter);
    }

    /// @inheritdoc PodERC20Fixed
